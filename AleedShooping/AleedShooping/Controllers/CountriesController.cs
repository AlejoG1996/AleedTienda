    ...
    public class CountriesController : Controller
    {
        ...
        public async Task<IActionResult> AddState(StateViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                return Json(new { isValid = true, html = ModalHelper.RenderRazorViewToString(this, "_ViewAllStates", model) });
        ...
        public async Task<IActionResult> AddCity(CityViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                catch (DbUpdateException dbUpdateException)
                {
                    if (dbUpdateException.InnerException.Message.Contains("duplicate"))
                    {
                        _flashMessage.Danger("Ya existe una ciudad con el mismo nombre para  este Departamento/Estado.");
                    }
                    else
                    {
                        _flashMessage.Danger(dbUpdateException.InnerException.Message);
                ...
                return Json(new { isValid = true, html = ModalHelper.RenderRazorViewToString(this, "_ViewAllCities", model) });
